...
import { useGetClients } from "@/admin/features/clients/api/get-clients";
...
import { CreateClientSheet } from "@/admin/features/clients/components/create-client.sheet";
import { generatePath, useNavigate } from "react-router-dom";
import { adminRoutePaths } from "../../app/config/route-paths.config";
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Button
          ...
          onClick={() =>
            navigate(
              generatePath(adminRoutePaths.clientDetail, {
                id: row.original.id,
              }),
            )
          }
